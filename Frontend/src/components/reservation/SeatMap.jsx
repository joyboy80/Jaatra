...
const styles = {
  Available: "bg-white text-jaatra-ink ring-slate-200 hover:bg-jaatra-mint hover:text-jaatra-navy hover:ring-jaatra-teal/40",
  Selected: "seat-selected bg-jaatra-teal text-white ring-jaatra-teal",
  ...
  return (
    <div className="rounded-xl bg-white p-4 shadow-sm ring-1 ring-slate-200">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h2 className="text-lg font-bold text-jaatra-ink">Seat Layout</h2>
          <p className="mt-1 text-sm text-jaatra-gray">Choose one available seat for this exact trip.</p>
        </div>
        <div className="flex items-center gap-2 rounded-lg bg-slate-50 px-3 py-2 text-sm font-semibold text-jaatra-gray">
          <BusFront className="h-4 w-4 text-jaatra-teal" />
          Front
        </div>
      </div>

      <div className="mt-5 rounded-xl bg-slate-50 p-3">
        <div className="mb-4 flex items-center justify-between rounded-lg bg-white px-3 py-2 text-sm font-semibold text-jaatra-gray ring-1 ring-slate-200">
          <span>Driver</span>
          <DoorOpen className="h-5 w-5 text-jaatra-amber" aria-label="Emergency exit" />
        </div>
        ...
        <div className="mt-5 text-center text-xs font-bold uppercase tracking-wide text-jaatra-gray">Back</div>
      </div>

      <div className="mt-4 grid grid-cols-2 gap-2 text-xs font-semibold text-jaatra-gray sm:grid-cols-4">
