...
export default function Logo({ compact = false, light = false }) {
  return (
    <div className="flex min-w-0 items-center gap-3">
      <div className="relative grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-jaatra-teal text-white shadow-glow">
      ...
      {!compact && (
        <div className="min-w-0">
          <div className={`text-xl font-extrabold leading-6 ${light ? "text-white" : "text-jaatra-ink"}`}>
            Jaatra
          </div>
          <div className={`text-xs font-medium ${light ? "text-white/75" : "text-jaatra-gray"}`}>
